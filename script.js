...
// Add an event listener to the image such that when the user presses a key, if the input value is "CSH", change the p tag text to be "Correct" and the text color to be green. Else, change the text to be "Incorrect" and the text color to be red.
